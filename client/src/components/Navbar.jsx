...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-between mx-4 lg:mx-44'>
      <Link to='/'><img className='W-32 sm:w-44' src={assets.logo} alt="" /></Link>
      {
        ...
        : <button onClick={()=>openSignIn({})}  className='bg-zinc-800 text-white flex items-center gap-4 px-4 py-2 sm:py-3 text-sm rounded-full'>Get started <img className='w-3 sm:w-4' src={assets.arrow_icon} alt="" />
      </button>
      }
